...
const SignUpModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div 
      className="fixed inset-0 z-50 flex items-start justify-center pt-8 md:pt-20 p-4 bg-black/20 backdrop-blur-[2px]"
      onClick={onClose}
    >
      {/* Modal Container */}
      <div 
        className="relative w-full max-w-[420px] md:max-w-[520px] -mt-5 rounded-2xl shadow-2xl scale-70 bg-white/10 backdrop-blur-2xl border border-white/20"
      ...
      >
        ...
        <div className="hidden md:block w-full h-32  opacity-10"></div>

        {/* Modal Content */}
        <div className="px-6 -mt-20 md:px-12 pb-8 md:pb-12 pt-6 md:pt-0">
          {/* Title */}
          ...
          <div className="mb-4">
            <input
              ...
              className="w-full px-4 py-3 md:py-4 border border-gray-700 shadow-2xl rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-red-600 transition-colors text-sm md:text-base"
            />
          </div>
          ...
          <button 
            ...
            className="w-full py-3 md:py-4 bg-[#DE2A02] hover:bg-red-600 text-white font-semibold rounded-lg transition-colors mb-4 text-sm md:text-base">
            Continue
          </button>
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <span className="text-gray-400 text-xs md:text-sm uppercase">or</span>
            <div className="flex-1 h-px bg-gray-700"></div>
          </div>
          ...
          {/* Promo Code Link */}
          <button className="flex items-center justify-center gap-2 text-gray-400 hover:text-white transition-colors mb-6 md:mb-8 mt-15 w-full text-sm md:text-lg">
            I have promo code
          ...
          {/* Terms and Privacy */}
          <div className="text-center text-xs md:text-sm text-gray-500 mt-15">
